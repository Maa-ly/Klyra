...
contract RouterTest is BaseTest {
    ...
    function testUpdateAggregationRouter() public {
        ...
        emit Router1inch.RouterUpdated(
            Router1inch.RouterType.AGGREGATION,
            KlyraConstants.DEFAULT_ROUTER,
            newRouter
        );
    ...
    function testUpdateUnoswapRouter() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit Router1inch.RouterUpdated(
            Router1inch.RouterType.UNOSWAP,
            KlyraConstants.DEFAULT_ROUTER,
            newRouter
        );
    ...
    function testUpdateClipperRouter() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit Router1inch.RouterUpdated(
            Router1inch.RouterType.CLIPPER,
            KlyraConstants.DEFAULT_ROUTER,
            newRouter
        );
    ...
    function testUpdateGenericRouter() public {
        ...
        vm.expectEmit(true, true, true, true);
        emit Router1inch.RouterUpdated(
            Router1inch.RouterType.GENERIC,
            KlyraConstants.DEFAULT_ROUTER,
            newRouter
        );
